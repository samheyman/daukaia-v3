      ...
      <div>
        ...
        <ol className="list-decimal list-inside ">
          <li className="my-4 font-bold">
            ...
            <ul>
              <li className="font-normal ps-5 mt-2 space-y-1 list-disc list-inside">
                ...
                contributions made on our website. We reserve the right to
          ...
          <li className="my-4 font-bold">
            ...
            <ul>
              <li className="font-normal ps-5 mt-2 space-y-1 list-disc list-inside">
                All donations are made in NOK (Norwegian Krone) and may be
          ...
          <li className="my-4 font-bold">
            ...
            <ul>
              <li className="font-normal ps-5 mt-2 space-y-1 list-disc list-inside">
                All donations will be used to support Daukaia Norge’s mission
                and initiatives.
              </li>
              <li className="font-normal ps-5 mt-2 space-y-1 list-disc list-inside">
