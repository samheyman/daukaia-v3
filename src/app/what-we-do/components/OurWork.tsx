      ...
      <div className="flex flex-col">
        ...
        <div className="flex-1 flex flex-col lg:flex-row items-start justify-between">
          <div className="flex-1">
            ...
            <p className="text-lg md:text-base my-4">
              We are located in a pre-school in the Noel Wheelock neighborhood
              in Ocotal, where we have our own classroom, kitchen, playground
              and vegetable garden.
            </p>
            <p className="text-lg md:text-base my-4">
              Children at Daukaia receive a daily meal, educational and
              emotional support, and the opportunity to engage in activities and
              play.
            </p>
          </div>
